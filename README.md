...
| GET    | `/records`                               | Lista todos os registros cadastrados de maneira paginada (Query params opcionais: page e page-size)                                                       | 200 OK               | -                                                                      |
| GET    | `/records/{id}`                          | Busca um registro específico por ID                                                                               | 200 OK               | 404 Not Found                                                          |
| GET    | `/records/moodstats`| Retorna pontos (X e Y) dos últimos 7 dias baseado na data da requisição, onde X é um dia e Y é a média de humor desse dia | 200 OK               | -             |
