...
public interface RecordRepository extends JpaRepository<Record, UUID> {
    ...
    @Query("select r from Record r where r.createdAt between :sevenDaysBefore and :requestDate order by r.createdAt desc")
    Optional<List<Record>> findAllLastWeek(@Param("requestDate") LocalDateTime requestDate, @Param("sevenDaysBefore") LocalDateTime sevenDaysBefore);
}
